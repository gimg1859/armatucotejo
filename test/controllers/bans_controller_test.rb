...
class BansControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ban" do
    assert_difference('Ban.count') do
      post bans_url, params: { ban: { endtime: @ban.endtime, log: @ban.log, starttime: @ban.starttime } }
    end
  ...
  test "should update ban" do
    patch ban_url(@ban), params: { ban: { endtime: @ban.endtime, log: @ban.log, starttime: @ban.starttime } }
